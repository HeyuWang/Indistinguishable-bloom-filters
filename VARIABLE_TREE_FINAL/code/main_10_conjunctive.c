    ...
    if (argc == 2){
        ...
        if (strcmp(argv[1],"loadandsearch") == 0){
            ...
            // char *mutli5[5] = {
                ...
                // "Classical","orogenic","relatively", "various","environments",//dataitem[a0073638.txt]中提取出来的5个关键词
                
                // "Understanding"," geometry", "earth","upper","crust",  //dataitem[a0073763.txt]

                // "systems","widely","used","variety","applications",   //dataitem[a0073512.txt]

                // "award","supports","theoretical","computational","research",//dataitem[a0073546.txt]

                // "methods","high","accuracy","alternatives","finite"};//dataitem[a0073048.txt]
            ...
            fprintf(f,"average searching time corresponding to %d files of 10 conjunctive trapdoor is %f seconds \n ",NUMBEROFFILES,sum/5.0);
