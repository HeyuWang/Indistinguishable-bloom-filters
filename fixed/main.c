    ...
    if (argc == 2){
       ...
       if (strcmp(argv[1],"loadandsearch") == 0){
            ...
            // char *multi2[5] = {
                "Differences","population","pathways","elucidated","particularly",//从dataitem[dataitem[a0073270.txt]]中提取出来的5个关键词
            // char *multi3[5] = {
                "methasis","exchanged","reactions","appropriate","additives",//从dataitem[a0073851.txt]中提取出来的5个关键词
            // char *multi4[5] = {
                "Jagannathan","Ramanujam","performance","depends","how",//从dataitem[a0073800.txt]中提取出来的5个关键词
            // char *mutli5[5] = {
                "predation","fish","survivorship","antipredator","growth"};//从dataitem[a0073071.txt]中提取出来的5个关键词
            ...
            for (int i = 0; i < 5; i++){
                ...
                findv3_disjunctive(bft,multitrapdoor,1);
            ...
            fprintf(f,"average searching time corresponding to %d files of 5 disjunctive multitrapdoor is %f seconds \n ",NUMBEROFFILES,sum/5.0);


            char *multi10[5][10] = {"Farrell","Morse","herbivorous","hostplants","foodplants","despite","apparent","advantages","multiple","scarce",//从dataitem[a0073330.txt]中提取出来的5个关键词
            // char *multi2[5] = {
            ...
            for (int i = 0; i < 5; i++){
                ...
                for(int j = 0; j<10;j++){
                    get_a_trapdoor_of_a_keyword(multi10[i][j],multitrapdoor[j]);
                }
                multitrapdoorfinsh = clock();
                ...
                findv4_disjunctive(bft,multitrapdoor,1);
            ...
            fprintf(f,"average searching time corresponding to %d files of 10 disjunctive trapdoor is %f seconds \n ",NUMBEROFFILES,sum/5.0);

char *multi5[5][5] = {"Farrell","Morse","herbivorous","hostplants","foodplants",//从dataitem[a0073330.txt]中提取出来的5个关键词
            // char *multi2[5] = {
                "Differences","population","pathways","elucidated","particularly",//从dataitem[dataitem[a0073270.txt]]中提取出来的5个关键词
            // char *multi3[5] = {
                "methasis","exchanged","reactions","appropriate","additives",//从dataitem[a0073851.txt]中提取出来的5个关键词
            ...
            for (int i = 0; i < 5; i++){
                ...
                for(int j = 0; j<5;j++){
                    get_a_trapdoor_of_a_keyword(multi5[i][j],multitrapdoor[j]);
                }
                multitrapdoorfinsh = clock();
            ...
            fprintf(f,"average searching time corresponding to %d files of 5 multitrapdoor 10 conjunctive is %f seconds \n\n ",NUMBEROFFILES,sum/5.0);
